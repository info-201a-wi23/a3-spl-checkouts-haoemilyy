...
```
This chart compares the material type of the Seattle Public Library's checkouts for Charles Dickens' books. I included this chart because I was interested to analyze how material types for books change over time, especially as technology has become more integrated in our lives. I was also wondering what material type users generally prefer to read, whether it's print or digital. A pattern I noticed is how each of the material type categories seem to have declined in total checkouts from January 2022 up until around October 2022 before increasing again. In the case of audiobooks and ebooks, which have been the main preference of material types for users, their total checkouts increased greatly around December and January, with ebooks spiking up to almost 300 total checkouts. The spikes in total checkouts for audiobooks, ebooks, and print books around this time could be attributed to the holidays and New Year's resolutions of reading more. 
...
```
This bar chart compares Charles Dickens' top 10 books, based on digital checkouts at the Seattle Public Library. I thought it would be interesting to compare these factors to see which of his works are more or less popular, and how much more or less popular they are in relation to one another. Based on my previous knowledge of Charles Dickens, I knew that *A Tale of Two Cities* (845 checkouts) would be his most popular book, but looking at this data visualization, *David Cooperfield* (715 checkouts) isn't too far behind. But, by a large margin, both *A Tale of Two Cities* and *David Cooperfield* are by far his most popular books, while after *Oliver Twist*, the rest of his books only have less than a hundred checkouts in the entire 2022 to 2023 year. 
